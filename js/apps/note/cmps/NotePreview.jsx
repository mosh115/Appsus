...
export class NotePreview extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        // if (prevState.note.style !== this.state.note.style)
    ...
    toggleColorPalette = () => {
        this.setState({
            isShowColorPalette: !this.state.isShowColorPalette,
        })
    }

    changeBgColor = (color) => {
        this.setState((prevState) => ({ note: { ...prevState.note, style: color } }),
            // this.saveNote()
        )
    }
    ...
    render() {
        const { note, isHover, isShowColorPalette } = this.state
        const btnAction = <div className="note-actions">
            ...
            <button onClick={this.toggleColorPalette}>
            ...
            <button onClick={this.onRemoveNote} >
        ...
        return (
            <section className="note-preview" onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave}
                ...
                <div style={{ visibility: isShowColorPalette ? 'visible' : 'hidden' }}>
                    <ColorPalette changeBgColor={this.changeBgColor} />
                </div>
